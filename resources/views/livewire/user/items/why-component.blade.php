    ...
    <div class="container py-5">
        ...
        <div class="row g-4 text-center mt-4">
            <div class="col-md-4 equal-height">
                <div class="feature-box">
                    <div class="feature-content">
                        ...
                        <p>
                            Our expert installation teams ensure seamless deployment of all door and access systems, with attention to safety, aesthetics, and technical integration.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 equal-height">
                <div class="feature-box">
                    <div class="feature-content">
                        <i class="fa fa-tools feature-icon"></i>
                        <h5 class="mb-3">Preventive Maintenance</h5>
                        <p>
                            Our AMC (Annual Maintenance Contracts) keep your systems in peak condition with scheduled checkups, updates, and part replacements as needed.
                        </p>
                    </div>
                </div>
            </div>
