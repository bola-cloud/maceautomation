                ...
                <div class="et_pb_module et_pb_text et_pb_text_36 et_pb_text_align_center et_pb_bg_layout_light">
                    <div class="et_pb_text_inner">
                        ...
                        <ol>
                            ...
                            <li style="text-align: justify;">
                                <strong style="font-size: 16px;">Integrated Access Control</strong>
                                <p style="text-align: justify;">
                                    Enhance security with biometric readers, card access, or motion sensors integrated directly into the door system. Ideal for facilities that demand controlled entry and exit.
                                </p>
                            </li>
                            ...
                            <li style="text-align: justify;">
                                <strong style="font-size: 16px;">Energy Efficiency & Air Control</strong>
                                <p style="text-align: justify;">
                                    Minimize energy loss with superior sealing and efficient rotation mechanisms that reduce air exchange and maintain interior climate stability, especially in high-traffic entrances.
                                </p>
                            </li>
                        </ol>
